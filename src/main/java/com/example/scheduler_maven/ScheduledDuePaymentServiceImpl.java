...
import com.example.scheduler_maven.shcedule.ScheduledDuePayment;
import com.example.scheduler_maven.shcedule.ScheduledDuePaymentRepository;
import com.example.scheduler_maven.shcedule.ScheduledDuePaymentService;
...
//        return new CronTrigger("0/" + dueDay + " * * * * ?");
//    }
//
...
//
//        dueDa.forEach(e -> {
//            if (e.getEndDate().isAfter(currentDate)) {
//                e.setStatus("Paid");
//            }
//        });
